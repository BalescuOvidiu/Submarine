...
void Panel::setSizes (
	...
	this->maxX = maxX;
	this->maxY = maxY;
	this->marginSize = Ruller::gridToPixel (marginSize);
 ...
 *  @brief:
 */
double Panel::getMarginGrid () {
	return Ruller::pixelToGrid (this->marginSize);
}

/**
 *  @brief:
 */
double Panel::getMarginMeter () {
	return Ruller::pixelToMeter (this->marginSize);
}

/**
 *  @brief:
 */
sf::Vector2f Panel::getMarginVector2f () {
	return sf::Vector2f (this->marginSize, this->marginSize);
}

/**
 *  @brief:
 */
sf::Vector2f Panel::getMarginVector2fGrid () {
	return Ruller::pixelToGrid (getMarginVector2f ());
}

/**
 *  @brief:
 */
sf::Vector2f Panel::getMarginVector2fMeter () {
	return Ruller::pixelToMeter (getMarginVector2f ());
}
